...
#define WIFISSID "Tamagna_2.4G" // Put your WifiSSID here
#define PASSWORD "30033003" // Put your wifi password here
...
void loop() {
  ...
  float sensor = dummy_temp;
  dummy_temp = dummy_temp + 2;
